...
function openModal(e) {
    ...
    var modalTitle = item.getAttribute("data-title");
    var modalText = item.getAttribute("data-text");
    var btnText = item.getAttribute("data-btn-text");
    var btnLink = item.getAttribute("data-btn-link");
    ...
    var entrance = item.getAttribute("data-entrance");
...
//create new variable for header_btn for ease
    ...
    var button = item.getAttribute("data-btn");
